...
<footer class="bg-gray-50 " style="border-top: 2px solid black">
    <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8" id="footer">
{{--        <div class="items-center justify-between sm:flex">--}}
{{--			<span class="inline-block w-20 h-10 bg-gray-200 rounded-lg">--}}
{{--			</span>--}}
...
{{--        </div>--}}
        <div class=" border-gray-200">
            <nav class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-16 gap-y-8">
                <div>
